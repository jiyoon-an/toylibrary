						...
						<div class="col-lg-12">
							<div class="table-responsive">
	                            <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @if(isset($loantypes) && count($loantypes)>0)
                                        	@foreach ($loantypes as $loantype)
                                        		<tr>
                                        			<td>{{ $loantype->name }}</td>
                                        			<td>{{ $loantype->loan_price }}</td>
                                        			<td>{{ $loantype->note }}</td>
                                        			<td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right" role="menu">
                                                                <li><a href="{{ url('/loantype/'.$loantype->id.'/edit') }}">Edit</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#">
                                                                        <form action="{{ url('/loantype/'.$loantype->id) }}" method="post">
								...
								<a class="btn btn-success" href="{{ url('/loantype/add') }}">Add New Loan Type</a>
                            </div>
						</div>
                    </div>
                    <!-- /.row -->
