...
<html lang="en">
	<head>
		...
		<link href="{{ URL::asset('css/modalstyle.css') }}" rel="stylesheet" type="text/css"> <!--modal css-->
		<link href="{{ URL::asset('css/reset.css') }}" rel="stylesheet" type="text/css"> <!--modal css-->
	...
	<body id="home" style="font-family: 'Baloo Da', Arial, sans-serif;">
	    ...
	    <!-- JavaScripts -->		    
		<script src="{{ URL::asset('js/modernizr-2.8.3.min.js') }}" type="text/javascript"></script>  <!-- Modernizr /-->
		...
		<script src="{{ URL::asset('js/jssor.slider.min.js') }}" type="text/javascript"></script>
		...
		<!-- StikyMenu -->
		<script src="{{ URL::asset('js/stickUp.min.js') }}" type="text/javascript"></script>
		...
		<!-- Smoothscroll -->
		<script src="{{ URL::asset('js/jquery.corner.js') }}" type="text/javascript"></script> 
