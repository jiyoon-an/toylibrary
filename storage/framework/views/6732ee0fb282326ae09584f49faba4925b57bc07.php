				...
				<div class="col-lg-6">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo e($membership->name); ?></h3>
						</div>
						<div class="panel-body">
							<h2 style="margin-top:5px;">$<?php echo e(number_format($membership->fee, 2)); ?> / year</h2>
							<ul>
								<li>Bond: <?php echo e($membership->minimum_bond == $membership->maximum_bond ? "$".number_format($membership->minimum_bond, 2) : "$".number_format($membership->minimum_bond, 2)." - $".number_format($membership->maximum_bond, 2)); ?></li>
								<li>Admin Fee: <?php echo e($membership->admin_fee == 0 ? "NOT APPLICABLE" : "$".number_format($membership->admin_fee)); ?></li>
								<li>May borrow up to <?php echo e($membership->toys_quantity); ?> toys at a time.</li>
								<li>May borrow up to <?php echo e($membership->gold_star_toys_quantity); ?> gold star toys at a time.</li>
								<li><?php echo e($membership->note); ?></li>
								<br>
								<li>
									<button class="btn btn-info" data-toggle="collapse" data-target="<?php echo e($membership->data_target); ?>" data-parent="#membershipGroup">Learn more</button>
									<button class="btn btn-danger" style="margin-left:10px;" onclick="window.location='<?php echo e(url('/register/'.$membership->id)); ?>'">Register</button>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="accordion-group">
				<div class="container collapse" id="annualMembershipRules">
					<div class="col-lg-12">
						...
						<a href="<?php echo e(asset('files/RulesofAnnualMembership2016.pdf')); ?>" target="_blank"><button class="btn btn-success"><h4>Download PDF</h4></button></a></center>
				...
				<div class="container collapse" id="partyHireRules">
					<div class="col-lg-12">
						...
						<a href="<?php echo e(asset('files/RulesofPartyHire2016.pdf')); ?>" target="_blank"><button class="btn btn-success"><h4>Download [PDF]</h4></button></a></center>
