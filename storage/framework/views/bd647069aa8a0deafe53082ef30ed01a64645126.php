...
<div style="background-color:#9999FF">
    <div class="container">        
        <div class="alert alert-success" style="background:#00b300; border-color:#009900; margin-top:20px;"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><?php echo e(Session::get('success')); ?></div>
    </div>
</div>
<?php endif; ?>
...
<div style="background-color:#9999FF">
    <div class="container">   
        <div class="alert alert-danger" style="margin-top:20px;"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><?php echo e(Session::get('failed')); ?></div>
    </div>
</div>
<?php endif; ?>
    ...
    <div class="row">
        <div class="row">    
            <div class="col-sm-4 wow fadeInDown text-center">
                ...
                <p><a class="btn btn-embossed btn-danger view" href="<?php echo e(url('/aboutus')); ?>" role="button">Find out more</a></p>
            </div>        
            <div class="col-sm-4 wow fadeInDown text-center">
                ...
                <p><a class="btn btn-embossed btn-primary view" href="<?php echo e(url('/membership')); ?>" role="button">Join us now</a></p>
            </div>        
            <div class="col-sm-4 wow fadeInDown text-center">
                ...
                <p><a class="btn btn-embossed btn-info view" role="button" href="<?php echo e(url('/toys')); ?>">View toys</a></p>
            </div>
        </div>    
        <br>    
        <div class="container-fluid"" style="text-align: center;">     
            <p>We have the <a href="<?php echo e(url('membership/1')); ?>" style="color:#005c99;">Annual membership</a> and <a href="<?php echo e(url('membership/2')); ?>" style="color:#005c99;">Party Hire</a> available for the parent/ guardian who live within Auckland.</p>
        </div>
    </div>
</div>
